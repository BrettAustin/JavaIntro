...
public interface FrontBackCappedListInterface<T> {
    ...
    /**
     * Adds a new entry to the beginning of the list if the list is not full. If the
     * entry is added, entries currently in the list are shifted down and the list
     * size is increased by 1.
     *
     * @param newEntry The object to be added as a new entry.
     * @return true if the object was added, false if the list was full and thus the
     *         object was not added
     */
    public boolean addFront(T newEntry);

    /**
     * Adds a new entry to the end of the list if the list is not full. Entries
     * currently in the list are unaffected. If the entry is added, the list size is
     * increased by 1.
     *
     * @param newEntry The object to be added as a new entry.
     * @return true if the object was added, false if the list was full and thus the
    ...
    /**
     * Removes an entry from the beginning of the list. Entries currently in the
     * list are shifted up. If an entry is removed, the list size is decreased by 1.
     *
    ...
    /**
     * Removes an entry from the end of the list. Entries currently in the list are
     * unaffected. If an entry is removed, the list size is decreased by 1.
     *
     * @return A reference to the removed entry or null if the list is empty.
     */
    public T removeBack();
